...
const LINKS = [
  {
    label: "email",
    href: "mailto:shayansiddiqui172@gmail.com",
    display: "shayansiddiqui172@gmail.com",
    icon: (
  ...
  {
    label: "github",
    href: "https://github.com/shayansiddiqui172",
    display: "github.com/shayansiddiqui172",
    icon: (
  ...
  {
    label: "linkedin",
    href: "https://linkedin.com/in/shayansiddiqui172",
    display: "linkedin.com/in/shayansiddiqui172",
    icon: (
      <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
